...
export const dashboardModules: NavigationItem[] = [
  ...
  { href: "/ai-agent", label: "AI Assistant", description: "Intent, prompt, guardrail, confidence, dan fallback control" },
  { href: "/knowledge-base", label: "Knowledge Base", description: "FAQ, artikel, dokumen, profil bisnis, dan sumber jawaban AI" },
